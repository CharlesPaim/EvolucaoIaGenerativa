...
export const OrchestratorIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18a.75.75 0 0 1 .75.75v.01a.75.75 0 0 1-1.5 0V18a.75.75 0 0 1 .75-.75Zm.75-5.25a.75.75 0 0 0-1.5 0v.01a.75.75 0 0 0 1.5 0v-.01ZM12 3.75a.75.75 0 0 1 .75.75v.01a.75.75 0 0 1-1.5 0V4.5a.75.75 0 0 1 .75-.75Zm-3.75.75a.75.75 0 0 0-1.5 0v.01a.75.75 0 0 0 1.5 0v-.01Zm-2.25 2.25a.75.75 0 0 1 .75.75v.01a.75.75 0 0 1-1.5 0v-.01a.75.75 0 0 1 .75-.75Zm10.5 0a.75.75 0 0 0-1.5 0v.01a.75.75 0 0 0 1.5 0v-.01Zm2.25-2.25a.75.75 0 0 1 .75.75v.01a.75.75 0 0 1-1.5 0V7.5a.75.75 0 0 1 .75-.75ZM12 12a2.25 2.25 0 1 0 0-4.5 2.25 2.25 0 0 0 0 4.5Z" />
...
export const BudgetIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.826-1.106-2.256 0-3.083C10.544 7.219 11.272 7 12 7c.768 0 1.536.219 2.121.659.95.712 2.368.712 3.318 0a1.5 1.5 0 0 0 0-2.223.45.45 0 0 0-.621 0A12.002 12.002 0 0 1 12 7c-2.39 0-4.685.934-6.364 2.613a8.959 8.959 0 0 0 0 12.775 8.959 8.959 0 0 0 12.728 0" />
  </svg>
);
