...
import { Stage2State, Stage } from '../types';
...
const Stage2: React.FC<Stage2Props> = ({ state, onVariableChange, onExecute, onComplete, isLoading, stage1Prompt, currentStage }) => {
