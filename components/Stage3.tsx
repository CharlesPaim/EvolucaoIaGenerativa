...
const Stage3: React.FC<Stage3Props> = ({ state, onFormChange, onExecute, isLoading, onComplete }) => {
    ...
    if (!appData) {
        return (
             <StageContainer
                ...
                description="Conclua o Estágio 2 para desbloquear esta etapa."
            >
                 <div className="text-center p-8 text-gray-500">
                    A IA irá gerar uma interface de aplicativo com base no seu prompt do Estágio 2.
                </div>
            </StageContainer>
        );
    }
    ...
    const isButtonDisabled = isLoading || Object.values(formState).some(v => v === '');
